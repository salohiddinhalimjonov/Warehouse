...
INSERT INTO warehouse_productmaterial (quantity, material_id_id, product_id_id, quantity_type)
VALUES
	('0.8', 1, 1, 'MTSQ'),
	('5', 3, 1, 'PC'),
	('10', 2, 1, 'MT'),
...
INSERT INTO warehouse_warehouse (remainder, price, material_id_id)
VALUES
	(12, 1500, 1),
	(200, 1600, 1),
	(40, 500, 2),
